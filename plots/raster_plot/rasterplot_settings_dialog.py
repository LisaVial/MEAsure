...
class RasterplotSettingsDialog(QtWidgets.QDialog):
    def __init__(self, parent, allowed_modes, allowed_channel_modes, settings=None):
        ...
        self.selected_channels_button.setEnabled(RasterplotSettings.ChannelSelection.SELECTION in allowed_channel_modes)
    ...
    def set_settings(self, settings):
        ...
        if settings.channel_selection == RasterplotSettings.ChannelSelection.ALL:
            self.all_channels_button.setChecked(True)
        elif settings.channel_selection == RasterplotSettings.ChannelSelection.SELECTION:
